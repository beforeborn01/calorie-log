...
export const getDailyRecords = (date: string) => apiGet<DailyRecords>('/records/daily', { date });
export const createRecord = (body: CreateRecordBody) => apiPost<DietRecord>('/records', body);
